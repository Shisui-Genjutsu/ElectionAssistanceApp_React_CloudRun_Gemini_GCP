...
// Inject into window for ChatPage highlight
if (typeof window !== "undefined") {
  (window as any).GLOSSARY = GLOSSARY;
}
    ...
    <div className="page" style={{ animation: "fade-up 0.5s" }}>
      ...
      <div className="card" style={{ marginTop: 36, padding: 32, display: "grid", gridTemplateColumns: "1fr 1.8fr", gap: 36 }}>
        <div>
          ...
          <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600, fontSize: 44, lineHeight: 1.1, marginTop: 8, letterSpacing: "-0.02em" }}>{stage.t}</div>
        ...
        <div style={{ fontSize: 17, lineHeight: 1.6, color: "var(--ink-soft)" }}>
          ...
          <div style={{ marginTop: 26, display: "flex", gap: 10 }}>
            <button className="btn sm" onClick={() => setRoute("chat", { prompt: `Can you explain the "${stage.t}" stage of the election process? What specifically happens during the period of ${stage.when}?` })}>
              Discuss with Saksham →
            </button>
        ...
        <div onClick={() => setTermOpen(null)} style={{
          ...
          <div className="card" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 520, padding: 28, animation: "fade-up 0.2s" }}>
            ...
            <div style={{ marginTop: 18, display: "flex", gap: 8 }}>
              <button className="btn primary" onClick={() => { setTermOpen(null); setRoute("chat", { prompt: `Tell me more about ${termOpen}` }); }}>Explain further →</button>
